...
\begin{enumerate}
    ...
    \item The scraper will write the text into a Word document and the code snippets into a \texttt{.txt} file using the \texttt{tagsoup} and \texttt{pandoc} libraries. 
\end{enumerate}
