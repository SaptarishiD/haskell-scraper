...
% \begin{figure}[h]
%     \centering
%     \includegraphics[width=0.8\textwidth]{figures/high-design.png}
...
\begin{enumerate}
    ...
    \item Insert newlines between each \texttt{<pre>} tag for formatting purposes. 
    ...
    \item Convert the pandocs into another intermediate format which can then be written into the respective \texttt{.docx} and \texttt{.txt} files
\end{enumerate}
